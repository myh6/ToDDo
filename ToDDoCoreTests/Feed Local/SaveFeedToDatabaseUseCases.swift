...
class SaveFeedToDatabaseUseCases: XCTestCase {
    ...
    //MARK: - Helpers
    private func makeSUT(file: StaticString = #file, line: UInt = #line) -> (sut: FeedCreate, store: FeedStoreSpy) {
        let store = FeedStoreSpy()
    ...
    private func expect(_ sut: FeedCreate, toCompleteWithError expectedError: NSError?, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {

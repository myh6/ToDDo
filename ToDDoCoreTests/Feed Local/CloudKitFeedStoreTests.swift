//
//  CloudKitFeedStoreTests.swift
//  ToDDoCoreTests
//
//  Created by Min-Yang Huang on 2023/3/20.
//

import XCTest
import ToDDoCore

class CloudKitFeedStoreTests: XCTestCase {
    ...
    private func makeSUT(file: StaticString = #file, line: UInt = #line) -> FeedStore {
        ...
        let sut = try! CloudKitFeedStore(identifier: "iCloud.com.toddo.test", storeURL: storeURL, bundle: storeBundle)
